...
import { Identifier, RaRecord, MutationMode, TransformData, RedirectionSideEffect, UseCreateMutateParams, UseUpdateMutateParams } from 'ra-core';
import { UseQueryOptions, UseMutationOptions } from 'react-query';
export interface EditProps<RecordType extends RaRecord = any, MutationOptionsError = unknown> {
...
export interface CreateProps<RecordType extends RaRecord = any, MutationOptionsError = unknown> {
    actions?: ReactElement | false;
    aside?: ReactElement;
    className?: string;
    component?: ElementType;
