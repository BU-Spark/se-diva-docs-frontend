 ...
 * };
 */
export declare const ListFilterContext: import("react").Context<ListFilterContextValue>;
export declare type ListFilterContextValue = Pick<ListControllerResult, 'displayedFilters' | 'filterValues' | 'hideFilter' | 'setFilters' | 'showFilter' | 'resource'>;
export declare const usePickFilterContext: (context: ListControllerResult) => ListFilterContextValue;
