...
export declare const NumberInput: {
    ({ className, defaultValue, format, helperText, label, margin, onChange, onBlur, parse, resource, source, step, min, max, validate, variant, inputProps: overrideInputProps, ...rest }: NumberInputProps): JSX.Element;
    propTypes: {
