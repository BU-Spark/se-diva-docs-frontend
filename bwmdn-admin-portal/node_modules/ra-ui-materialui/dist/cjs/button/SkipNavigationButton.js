...
var SkipNavigationButton = function () {
    ...
    return (react_1.default.createElement(StyledButton, { onClick: skipToContent, className: 'skip-nav-button', label: translate('ra.navigation.skip_nav'), variant: "contained" }));
};
