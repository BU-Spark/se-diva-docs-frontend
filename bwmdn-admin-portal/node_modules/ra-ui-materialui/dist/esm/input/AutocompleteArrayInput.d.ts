 ...
 */
export declare const AutocompleteArrayInput: <OptionType extends RaRecord = RaRecord, DisableClearable extends boolean = boolean, SupportCreate extends boolean = false>({ defaultValue, ...props }: AutocompleteArrayInputProps<OptionType, DisableClearable, SupportCreate>) => JSX.Element;
export declare type AutocompleteArrayInputProps<OptionType extends any = RaRecord, DisableClearable extends boolean | undefined = false, SupportCreate extends boolean | undefined = false> = Omit<AutocompleteInputProps<OptionType, true, DisableClearable, SupportCreate>, 'defaultValue'> & {
    defaultValue?: any[];
};
